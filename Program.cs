...
namespace Redis101Examples
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StreamEntry[] consumer1_messages = db.StreamReadGroup("hero:organizations", "hero_consumer_group1", "shield", ">", count:1);
            ...
            StreamPendingMessageInfo[] pendingMessage = db.StreamPendingMessages("hero:organizations", "hero_consumer_group1", 1,"shield", messageId);
